  ...
  return (
    <div className='relative w-[55rem] h-[37rem] p-8 flex flex-col justify-start bg-indigo-400'>
      <div className='w-fit h-fit py-5 flex flex-col justify-start gap-1'>
        ...
        <div className="w-96 h-9 pl-1 text-white text-base font-black mix-blend-soft">"Destiny Is A Funny Thing. You Never Know How Things Are Going To Work Out."</div>
      </div>
